...
{
  public class Arcanine : Rook, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Arcanine(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Arcanine(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Arcanine; } }

    public string ImagePath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Arcanine}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Arcanine}{FileSuffixes.ImageSuffix}"; } }
