...
{
  public class Charizard : King, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Charizard(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Charizard(Enums.BlackOrWhite teamSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Charizard; } }

    public string ImagePath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Charizard}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Charizard}{FileSuffixes.ImageSuffix}"; } }
