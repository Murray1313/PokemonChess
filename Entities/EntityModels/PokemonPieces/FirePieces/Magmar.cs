...
{
  public class Magmar : Bishop, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Magmar(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Magmar(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Magmar; } }

    public string ImagePath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Magmar}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Magmar}{FileSuffixes.ImageSuffix}"; } }
