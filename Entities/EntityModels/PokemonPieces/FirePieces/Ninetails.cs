...
{
  public class Ninetails : Queen, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Ninetails(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Ninetails(Enums.BlackOrWhite teamSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Ninetails; } }

    public string ImagePath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Ninetails}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.FireFolder}{PokemonNames.Ninetails}{FileSuffixes.ImageSuffix}"; } }
