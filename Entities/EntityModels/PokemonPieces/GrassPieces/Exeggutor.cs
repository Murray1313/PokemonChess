...
{
  public class Exeggutor : Bishop, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Exeggutor(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Exeggutor(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Exeggutor; } }

    public string ImagePath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Exeggutor}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Exeggutor}{FileSuffixes.ImageSuffix}"; } }
