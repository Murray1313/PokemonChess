...
{
  public class Oddish : Pawn, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Oddish(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Oddish(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Oddish; } }

    public string ImagePath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Oddish}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Oddish}{FileSuffixes.ImageSuffix}"; } }
