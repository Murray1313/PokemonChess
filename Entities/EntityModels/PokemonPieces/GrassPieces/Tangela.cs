...
{
  public class Tangela : Knight, IPiece
  {
    #region " Private "
    ...
    public Tangela(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Tangela(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Tangela; } }

    public string ImagePath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Tangela}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Tangela}{FileSuffixes.ImageSuffix}"; } }
