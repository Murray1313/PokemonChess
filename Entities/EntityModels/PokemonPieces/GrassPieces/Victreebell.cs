...
{
  public class Victreebell : Rook, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Victreebell(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Victreebell(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Victreebell; } }

    public string ImagePath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Victreebell}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.GrassFolder}{PokemonNames.Victreebell}{FileSuffixes.ImageSuffix}"; } }
