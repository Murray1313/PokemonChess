...
{
  public class Arbok : Bishop, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Arbok(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Arbok(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Arbok; } }

    public string ImagePath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Arbok}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Arbok}{FileSuffixes.ImageSuffix}"; } }
