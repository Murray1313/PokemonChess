...
{
  public class Gengar : Rook, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Gengar(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Gengar(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Gengar; } }

    public string ImagePath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Gengar}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Gengar}{FileSuffixes.ImageSuffix}"; } }
