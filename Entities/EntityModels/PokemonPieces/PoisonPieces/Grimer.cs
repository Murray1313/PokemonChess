...
{
  public class Grimer : Pawn, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Grimer(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Grimer(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Grimer; } }

    public string ImagePath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Grimer}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Grimer}{FileSuffixes.ImageSuffix}"; } }
