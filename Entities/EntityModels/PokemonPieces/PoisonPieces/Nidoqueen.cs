...
{
  public class Nidoqueen : Queen, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Nidoqueen(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Nidoqueen(Enums.BlackOrWhite teamSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Nidoqueen; } }

    public string ImagePath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Nidoqueen}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Nidoqueen}{FileSuffixes.ImageSuffix}"; } }
