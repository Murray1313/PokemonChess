...
{
  public class Weezing : Knight, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Weezing(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Weezing(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Weezing; } }

    public string ImagePath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Weezing}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.PoisonFolder}{PokemonNames.Weezing}{FileSuffixes.ImageSuffix}"; } }
