...
{
  public class Blastoise : King, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Blastoise(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Blastoise(Enums.BlackOrWhite teamSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Blastoise; } }

    public string ImagePath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Blastoise}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Blastoise}{FileSuffixes.ImageSuffix}"; } }
