...
{
  public class Lapras : Queen, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Lapras(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Lapras(Enums.BlackOrWhite teamSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Lapras; } }

    public string ImagePath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Lapras}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Lapras}{FileSuffixes.ImageSuffix}"; } }
