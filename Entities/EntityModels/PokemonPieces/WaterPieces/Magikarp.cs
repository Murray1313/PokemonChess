...
{
  public class Magikarp : Pawn, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Magikarp(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Magikarp(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Magikarp; } }

    public string ImagePath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Magikarp}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Magikarp}{FileSuffixes.ImageSuffix}"; } }
