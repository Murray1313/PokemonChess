...
{
  public class Poliwrath : Rook, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Poliwrath(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Poliwrath(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Poliwrath; } }

    public string ImagePath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Poliwrath}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Poliwrath}{FileSuffixes.ImageSuffix}"; } }
