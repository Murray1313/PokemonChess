...
{
  public class Seadra : Knight, IPiece
  {
    #region " Private "
    ...
    #region " Constructor "
    public Seadra(Enums.BlackOrWhite teamSide, int arrayLocation)
    {
      this.Side = teamSide;
      this.Location = new Location(arrayLocation);
    }

    public Seadra(Enums.BlackOrWhite teamSide, Enums.BoardColumns pieceSide)
    {
      this.Side = teamSide;
    ...
    #region " Properties "
    public string Name { get { return PokemonNames.Seadra; } }

    public string ImagePath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Seadra}{FileSuffixes.PieceSuffix}"; } }

    public string MainPath { get { return $"{FolderPaths.WaterFolder}{PokemonNames.Seadra}{FileSuffixes.ImageSuffix}"; } }
